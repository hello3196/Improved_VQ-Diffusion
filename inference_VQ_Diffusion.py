...
if __name__ == '__main__':
    ...
    wandb.init(project='clipscore_200', name = 'schedule_4_coco')
    ...
    wandb.finish()
    wandb.init(project='clipscore_200', name = 'schedule_5_coco')
    ...
    wandb.finish()
    wandb.init(project='clipscore_200', name = 'schedule_6_coco')
